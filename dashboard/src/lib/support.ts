...
const BODIES: Record<SupportTopic, string[]> = {
  ...
  // Answer lines are left blank for the reader to type on, and the two
  // permissions are asked separately because they are separate: quoting what
  // somebody wrote and putting their name next to it are different things to
  // agree to, and a single combined question makes the cautious answer "no" to
  // both. Defaulting each to No means silence is never read as consent.
  praise: [
    ...
    "",
    "",
    "May I quote this on trackwithtime.com?   Yes / No",
    "",
    "If yes, may I use your first and last name with it?   Yes / No",
    "",
    "Your name, if you said yes above:",
    "",
    "Leaving these blank means no to both, and nothing else changes either way.",
  ],
  problem: [
    "Thank you for telling me — I would rather hear it than not.",
    "",
    "What went wrong?",
    "",
    "",
    ...
    "",
    "",
    "Answer as much or as little as you like — even one line helps.",
  ],
  extension: [
    "Thank you for telling me — I would rather hear it than not.",
    "",
